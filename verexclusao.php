<html>
	...
	<body>
		...
		<form name="gerente" action="excluir.php" method="post" enctype="multipart/form-data">
			<b>ID:</b> <input type="number"  value="<?php echo $dados['id']; ?>" readonly > <br><br>
			<b>Nome:</b> <input type="text"  maxlength='80' style="width:550px" value="<?php echo $dados['nome']; ?>" readonly > <br><br>
